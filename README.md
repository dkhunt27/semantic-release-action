...
| new_release_git_head      | The sha of the last commit being part of the new release, if there was one. |
| new_release_git_tag       | The Git tag associated with the new release, if there was one. |
